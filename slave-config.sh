...
#core-site.xml
sudo sed -i '/<configuration>/a <property> <name>fs.default.name</name> <value>hdfs://master:9000</value> </property>' /home/$hdUserName/hadoop/etc/hadoop/core-site.xml
#mapred-site.xml
...
#hdfs-site.xml
sudo sed -i '/<configuration>/a <property> <name>dfs.replication</name> <value>2</value> </property> <property> <name>dfs.namenode.name.dir</name> <value>/home/'$hdUserName'/hadoop/data/hdfs/namenode</value> </property> <property> <name>dfs.datanode.data.dir</name> <value>/home/'$hdUserName'/hadoop/data/hdfs/datanode</value> </property> <property> <name>dfs.block.size</name> <value>256000000</value> </property>' /home/$hdUserName/hadoop/etc/hadoop/hdfs-site.xml
#yarn-site.xml
...
# sudo rm -rf /home/$hdUserName/hadoop/data/hdfs/datanode/*
